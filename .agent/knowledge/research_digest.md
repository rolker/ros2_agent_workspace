...
- The pattern repeats across large ROS 2 projects: Nav2 keeps its roadmap in the separate `docs.nav2.org` repo; MoveIt publishes its [roadmap on moveit.ai](https://moveit.ai/documentation/contributing/roadmap/); ros2_control's planning material lives on [control.ros.org](https://control.ros.org/rolling/doc/contributing/contributing.html); Autoware keeps documentation in a separate [autoware-documentation](https://github.com/autowarefoundation/autoware-documentation) repo — none keep roadmap/vision/governance as files in the code repo
