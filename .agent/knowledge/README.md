...
- **[Dependency Policy](dependency_policy.md)**: What a `package.xml` may depend on, local rosdep keys via `ROSDEP_SOURCE_PATH`, the upstream `ros/rosdistro` PR owed for each, and the hosted-CI step.
