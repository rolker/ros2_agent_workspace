...
- [ ] (low, Copilot R3) The #637 promotion gate lists three conditions, all about evidence, and says nothing about the link migration promotion forces. Verified: eight tracked files outside the work-plan directory link to `docs/design/planning_document_vocabulary.md` (`ROADMAP.md`, `.agent/templates/roadmap.md`, `.agent/knowledge/principles_review_guide.md`, the four instruction files, `.claude/skills/inspiration-tracker/SKILL.md`). Moving the draft to a numbered ADR breaks all eight. One clause on the gate — promotion carries the pointer updates — costs nothing now and is exactly the "check the consequences" step AGENTS.md § Post-Task Verification asks for — `docs/design/planning_document_vocabulary.md:414-421`
