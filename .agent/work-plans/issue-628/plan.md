...
workspace `docs/roadmap.md`, (2) discovery, (3) the sweep split + publish, (4)
...
| Add a template in `.agent/templates/` | Docs/skills that reference it | Yes — the design draft and `docs/roadmap.md` are its only referents today |
