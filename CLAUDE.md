...
.agent/scripts/worktree_create.sh --issue <N> --type layer --layer core --packages <project_repo> [--plan-file <path>]
source .agent/scripts/worktree_enter.sh --issue <N>
...
- When referencing any GitHub issue, PR, commit, or repository in summaries
  or reports, include a clickable markdown link on every mention.
