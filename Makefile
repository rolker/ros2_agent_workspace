.PHONY: help bootstrap setup-core setup-all build test clean status status-quick lock unlock format lint setup-dev health-check sync validate revert-feature pr-triage agent-build agent-run agent-shell push-gateway generate-skills
