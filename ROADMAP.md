...
| A `Provisional` ADR status for decisions made under deployment pressure and owed an off-season review | [#620](https://github.com/rolker/ros2_agent_workspace/issues/620) | planned | Specified in the [vocabulary draft](docs/design/planning_document_vocabulary.md#decisions-and-drafts-across-the-season-boundary) on 2026-09-18; lands in ADR-0001 and the ADR template when the draft is promoted (#637). Wrap-up decision list and seasonal review pass still to be filed |
